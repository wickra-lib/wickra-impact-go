/* wickra-impact C ABI — generated by cbindgen; do not edit by hand. */

#ifndef WICKRA_IMPACT_H
#define WICKRA_IMPACT_H
...
#define WICKRA_IMPACT_ERR_NULL -1

// `cmd_json` was not valid UTF-8.
#define WICKRA_IMPACT_ERR_UTF8 -2

// A panic was caught at the FFI boundary.
#define WICKRA_IMPACT_ERR_PANIC -3
...
WickraImpact *wickra_impact_new(const char *spec_json);
...
void wickra_impact_free(WickraImpact *handle);
...
int32_t wickra_impact_command(WickraImpact *handle, const char *cmd_json, char *out, uintptr_t cap);

// The library version as a static NUL-terminated string (do not free).
const char *wickra_impact_version(void);

#ifdef __cplusplus
}  // extern "C"
#endif  // __cplusplus

#endif  /* WICKRA_IMPACT_H */
